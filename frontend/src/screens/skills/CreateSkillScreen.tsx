...
type Props = NativeStackScreenProps<ProfileStackParamList, "CreateSkill">;
...
export function CreateSkillScreen({ navigation }: Props) {
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      await createSkill({ ...values, category, tags: [] }).unwrap();
      navigation.goBack();
    } catch {
      // surfaced below
    }
